...
// obtained from https://svn.apache.org/repos/asf/incubator/ctakes/trunk/ctakes-core/src/main/java/org/apache/ctakes/core/knowtator/KnowtatorAnnotation.java
...
public class KnowtatorAnnotation {
  ...
  public String toString() {
    ...
    // kesslewd changes begin
    // Previous code:
    //   builder.add("mentionSlots", this.annotationSlots);
    // This results in a java.lang.StackOverflowError 
    // because the second part of the map is a KnowtatorAnnotation that
    // also calls its toString() method and so on.
    // Instead of printing the object, print only the id.
    for (String key: this.annotationSlots.keySet()) {
      String textValue = this.annotationSlots.get(key).id;
      builder.add(key, textValue);
    }
    // kesslewd changes end
